...
func (s *SendStream) write(p []byte, limiter func(int) int) (bool, int, error) {
	_ = "STUB: not implemented"
	return false, 0, nil
}
...
func (s *SendStream) popRetransmissionFrame(maxBytes protocol.ByteCount, v protocol.Version) (_ ackhandler.StreamFrame, hasMore bool) {
	_ = "STUB: not implemented"
	return *new(ackhandler.StreamFrame), false
}
...
func (s *SendStream) SetPriority(urgency int8, incremental bool) { _ = "STUB: not implemented"; return }
