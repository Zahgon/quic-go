...
func (s *Stream) TryWriteAll(b []byte) error { _ = "STUB: not implemented"; return nil }
...
func (s *RequestStream) TryWriteAll(b []byte) error { _ = "STUB: not implemented"; return nil }
